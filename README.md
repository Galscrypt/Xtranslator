...
Расширение для автоматического перевода твиттер (Х) постов на русский язык в терминалах:
- `axiom.trade`
- `trade.padre.gg`

## Что умеет

- Автоматически переводит твиттер (Х) посты на поддерживаемых терминалах.
